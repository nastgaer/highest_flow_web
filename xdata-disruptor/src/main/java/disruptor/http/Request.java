...
public class Request {
	...
	public Request(Socket client) throws IOException, HTTPException {
		...
		contentType = HttpConfiguration.getMime().getContentType(requestFileExtension);
	}
	...
	private File translateURI() throws HTTPException {
		...
		return new File(HttpConfiguration.getDocumentRoot() + relURI);
	}
	...
	public String getMimeType() {
		if ((mimeType == null) || (mimeType == "")) {
			if (getRequestFile().isDirectory()) {
				mimeType = HttpConfiguration.getMime().getContentType("html");
			} else {
