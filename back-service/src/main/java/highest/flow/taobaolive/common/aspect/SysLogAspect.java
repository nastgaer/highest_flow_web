...
package highest.flow.taobaolive.common.aspect;

import com.fasterxml.jackson.databind.ObjectMapper;
import highest.flow.taobaolive.common.annotation.SysLog;
import highest.flow.taobaolive.common.utils.HttpContextUtils;
import highest.flow.taobaolive.common.utils.IPUtils;
...
public class SysLogAspect {
	...
	private void saveSysLog(ProceedingJoinPoint joinPoint, Object result, long time) {
		...
		String memberName = sysMember == null ? "" : sysMember.getMemberName();
		sysLog.setMemberName(memberName);
