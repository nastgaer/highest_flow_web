package highest.flow.taolive.xdata.http.httpclient.response;
...
public class PlainTextResponse extends Response<String> {
    ...
    protected String handleHttpResponseResult(CloseableHttpResponse httpResponse) throws Throwable {
        ...
        if (contentCharset == null || contentCharset.name().equalsIgnoreCase("UTF-8")) {
            return content;
        }
    ...
    private Charset getCharsetFromContent(String content) {
        content = HFStringUtils.getMiddleText(content, null, "</head>");

        //<meta http-equiv="content-type" content="text/html;charset=utf-8">
        String charset = HFStringUtils.getMiddleText(content, "charset=", "\"");
        if (StringUtils.isEmpty(charset)) {
            //<meta charset="gb2312" />
            charset = HFStringUtils.getMiddleText(content, "charset=\"", "\"");
        }
